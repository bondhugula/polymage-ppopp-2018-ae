...
from polymage_test_fusion import test_fusion_pipe
...
def build_test_fusion(app_data, g_size = None, t_size = None):
    pipe_data = app_data['pipe_data']

    out_test_fusion_pipe = test_fusion_pipe(pipe_data)
    
    R = pipe_data['R']
    C = pipe_data['C']

    live_outs = out_test_fusion_pipe
